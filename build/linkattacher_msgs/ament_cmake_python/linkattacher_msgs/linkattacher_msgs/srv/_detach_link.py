...
class Metaclass_DetachLink_Event(type):
    """Metaclass of message 'DetachLink_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__detach_link__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__detach_link__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__detach_link__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__detach_link__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__detach_link__event
...
class DetachLink_Event(metaclass=Metaclass_DetachLink_Event):
    """Message class 'DetachLink_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<linkattacher_msgs/DetachLink_Request, 1>',
        'response': 'sequence<linkattacher_msgs/DetachLink_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['linkattacher_msgs', 'srv'], 'DetachLink_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['linkattacher_msgs', 'srv'], 'DetachLink_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from linkattacher_msgs.srv import DetachLink_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, DetachLink_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'DetachLink_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from linkattacher_msgs.srv import DetachLink_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, DetachLink_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'DetachLink_Response'"
...
class Metaclass_DetachLink(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _detach_link.Metaclass_DetachLink_Event._TYPE_SUPPORT is None:
                _detach_link.Metaclass_DetachLink_Event.__import_type_support__()
...
class DetachLink(metaclass=Metaclass_DetachLink):
    ...
    from linkattacher_msgs.srv._detach_link import DetachLink_Event as Event
